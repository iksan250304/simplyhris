    ...
    <header className="glass sticky top-0 z-40" style={{ borderRadius: 0, borderLeft: "none", borderRight: "none", borderTop: "none" }}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
        ...
        <nav className="flex items-center gap-0.5">
          ...
          <button onClick={() => router.push("/payroll")} className={`nav-item ${pathname === "/payroll" ? "on" : ""}`}>
            Slip Gaji
          </button>
          <div className="w-px h-4 bg-slate-200 mx-1.5" />
          <button onClick={logout} className="nav-item text-slate-400 hover:text-red-500" style={{ fontSize: 12 }}>
            Keluar
          </button>
        </nav>
      </div>
