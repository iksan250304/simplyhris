  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: "linear-gradient(160deg, rgba(235,245,255,0.85) 0%, rgba(240,244,248,0.85) 40%, rgba(238,242,255,0.85) 100%)",
        }}
      />
      <div className="relative z-10 w-full flex items-center justify-center">
        <div className="w-full max-w-[360px] fade-up">
          <div className="flex flex-col items-center mb-7">
            <Logo size={60} />
            <h1 className="mt-4 text-[22px] font-bold text-slate-900 tracking-tight">Simply HRIS</h1>
            <p className="text-slate-500 text-[13px] mt-0.5">Employee Portal</p>
          </div>

          <div className="glass rounded-[22px] p-7">
            <p className="text-[13px] font-semibold text-slate-500 mb-5 uppercase tracking-widest">Masuk</p>
            <form onSubmit={submit} className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-[12px] font-semibold text-slate-500 tracking-wide">Email</label>
                <input
                  type="email"
                  className="field"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[12px] font-semibold text-slate-500 tracking-wide">Password</label>
                <input
                  type="password"
                  className="field"
                  placeholder="••••••••"
              ...
              <button type="submit" className="btn btn-blue w-full mt-1" disabled={loading}>
                {loading ? (
                  <>
                    <Spinner /> Memeriksa...
                  </>
          ...
          <p className="text-center text-[11px] text-slate-400 mt-5">© 2026 Simply HRIS · Hak cipta dilindungi</p>
        </div>
      </div>
    </div>
  );
